...
// Xserver方式: 各HTMLファイルで定義されたREDIRECT_URLを使用
// HTMLファイルの<head>内で const REDIRECT_URL = '...'; として定義されています
const redirectUrl = typeof REDIRECT_URL !== 'undefined' ? REDIRECT_URL : 'https://smile-zemi.jp/shogaku/lp/compare3/';
